...
lsp.on_attach(function(client, bufnr)
  ...
  vim.keymap.set("n", "<leader>vs", function() vim.lsp.buf.typehierarchy("supertypes") end, opts)
  vim.keymap.set("n", "<leader>vS", function() vim.lsp.buf.typehierarchy("subtypes") end, opts)
