# Generated by Powerlevel10k configuration wizard on 2024-02-13 at 18:35 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RUST_VERSION_SHOW_ON_COMMAND='cargo|rustfmt|doctest|clippy|rustc'
  # Custom icon.
